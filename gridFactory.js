window.gridFactoryMakeGrid = function (canvasContext, hexMathsHelper, hexSideLength) {
		...
		drawHexGrid: function (hexesAcross, hexesDown, options) {
			...
			for (var x = 0; x < hexesAcross; x++) {
				for (var y = 0; y < hexesDown; y++) {
					var offset = this.getCoordinatesFromGridPosition(x, y, this.sideLength)
...
gridFactory = window.gridFactory;