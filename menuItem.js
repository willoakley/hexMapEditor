...
function initMenu() {
	...
	addMenuItems("hex", "buildingMenu", [
		...
		{ quantity: 1, name: "Barracks", item: window.drawableFactory.newDrawableMultiple("barracks", [ { draw: window.drawFuncs.heightTwoBuilding }, { move: "s", draw: window.drawFuncs.heightTwoBuilding }, ]) },
